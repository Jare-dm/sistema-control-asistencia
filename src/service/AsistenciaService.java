...
public class AsistenciaService {
    ...
    public void registrarFalta(String alumno, String fecha) {
    ...
    public void registrarAsistencia(String alumno, String fecha) {

        Asistencia asistencia = new Asistencia(alumno, fecha, "PRESENTE");
        asistencias.add(asistencia);

        System.out.println("Asistencia registrada correctamente");
    }
    public List<Asistencia> filtrar(String fecha, String curso) {
    ...
    public void buscarAlumno(String nombre) {
        ...
        for (Asistencia a : asistencias) {
            if (a.getAlumno().equalsIgnoreCase(nombre)) {
